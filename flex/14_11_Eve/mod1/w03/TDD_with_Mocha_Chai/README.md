...
1. npm install// install it as a dependency of our project
2. npm install --save-dev // install it as a dev dependency
3. npm install --global // installs it globally on your OS
