...
// database of users
const users = {
  1: {id: 1, email: 'obiwan@gmail.com',  password: bcrypt.hashSync('helloThere')},
  2: {id: 2, email: 'gimli@gmail.com',   password: bcrypt.hashSync('andMyAxe')},
  3: {id: 3, email: 'a@b.com',           password: bcrypt.hashSync('123')},
};
...
app.use(cookieSession({
  name: 'session',
  keys: ['thisistotallynotasecretkey', 'thisist'],
}))
